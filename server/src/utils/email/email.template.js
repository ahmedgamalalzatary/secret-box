export const confirmEmailTemplate = async ({ OTPCode } = {}) => {
  ...
  <p>Thank you for registering with  SecretBox.</p>
  ...
  <p style="margin-top: 30px;">Thanks,<br><strong> SecretBox Developer: Adham Zain</strong></p>
</div>` 
...
export const forgetPasswordTemplate = async ({ OTPCode = "" } = {}) => {
  ...
  <div style="font-family: Arial, sans-serif; padding: 20px; background-color: #ffffff; color: #333;">
    ...
    <p>You requested to reset your password for the <strong>SecretBox</strong>.</p>
    ...
    <p style="margin-top: 30px;">Thanks,<br><strong>SecretBox</strong><br><small>Developer: Adham Zain</small></p>
  </div>
  `;
};
